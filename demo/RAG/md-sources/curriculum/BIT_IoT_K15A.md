# BIT_IoT_K15A - Bachelor Program of Information Technology, Internet of Things (CTĐT ngành CNTT, chuyên ngành Internet Vạn Vật)


## Curriculum Information - BIT_IoT_K15A

- **Decision**: 973/QĐ-ĐHFPT dated 10/26/2022

### Description - BIT_IoT_K15A
...
## Program Learning Outcomes (PLOs) - BIT_IoT_K15A
...
- **MCP301**: Microcontroller Programming_Lập trình vi điều khiển (3 credits)
- **PRC391**: Cloud Computing_Điện toán đám mây (3 credits) | Pre-requisite: PRN29x
...
### Semester 7
- **BDP301c**: Blockchain Basics_Công nghệ blockchain cơ bản (3 credits)
