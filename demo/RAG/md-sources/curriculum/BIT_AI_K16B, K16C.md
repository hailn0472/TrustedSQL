# BIT_AI_K16B, K16C - Bachelor Program of Information Technology, Artificial Intelligence Major (Chương trình cử nhân ngành CNTT, chuyên ngành Trí tuệ nhân tạo)


## Curriculum Information - BIT_AI_K16B, K16C

- **Decision**: 669/QĐ-ĐH-FPT dated 08/05/2022

### Description - BIT_AI_K16B, K16C
...
## Program Learning Outcomes (PLOs) - BIT_AI_K16B, K16C
...
- **PLO14**: Be able to apply mathematics (optimization theory, statistical probability, linear algebra), advanced algorithms, digital signal processing... to AI problems.
- **PLO15**: Be able to apply knowledge of AI, AI programming, machine learning... to build intelligent systems such as decision support systems, forecasting systems, identification systems, etc.
- **PLO16**: Be able to evaluate techniques and technologies related to AI, highlighting strengths and weaknesses of techniques and technologies.
- **PLO17**: Be able to update and utilize advanced tools and techniques in the field of AI in particular and IT in general.
...
- **PRP201c**: Python Programming_Lập trình Python (3 credits) | Pre-requisite: Recommend to have knowledge of basic programming in advance
...
### Semester 5
- **AIL302m**: Machine Learning_Học máy (3 credits) | Pre-requisite: MAS291
- **AIP391**: AI programming project_Dự án lập trình TTNT (3 credits) | Pre-requisite: AIG201c, PRP201c
- **CSD301**: Advanced Algorithms_Giải thuật nâng cao (3 credits) | Pre-requisite: CSD202
...
- **IMP301**: Image Processing_Xử lý ảnh (3 credits) | Pre-requisite: Recommend to have knowledge of Digital Signal Processing (DGT301) in advance
...
### Semester 9
- **AIP490**: AI Capstone Project_Đồ án tốt nghiệp TTNT (10 credits) | Pre-requisite: - Student must pass Machine Learning (AIL30x). - Pass OJT202 - Pass 60% of total credits of selected combo - Pass 80% of total credits (PHE_COM* and OJT excluded)
