# BIT_IoT_K16D-17A - Bachelor Program of Information Technology, Internet of Things (CTĐT ngành CNTT, chuyên ngành Internet Vạn Vật)


**English Name**: Bachelor Program of Information Technology, Internet of Things


## Curriculum Information - BIT_IoT_K16D-17A

- **Decision**: 1374/QĐ-ĐHFPT dated 12/29/2023

### Description - BIT_IoT_K16D-17A
...
Đào tạo cử nhân ngành Công nghệ thông tin (CNTT), chuyên ngành Internet vạn vật (IoT) có nhân cách và năng lực đáp ứng nhu cầu thực tế của xã hội, nắm vững kiến thức chuyên môn và thực hành, có khả năng tổ chức, thực hiện và phát huy sáng tạo trong các công việc liên quan đến các chuyên ngành được đào tạo.
...
## Program Learning Outcomes (PLOs) - BIT_IoT_K16D-17A
...
- **PLO9**: Be able to explain at a basic level the concepts related to computer architecture, operating systems, computer networks, databases…
...
- **PLO13**: Be able to explain the roles and responsibilities of a IoT specialist.
- **PLO14**: Propose reliable solutions for device and application, aiming to protect user's data and privacy.
- **PLO15**: Develop IoT web and mobile apps for multiple platforms and devices.
- **PLO16**: Evaluate IoT-based techniques and technologies, master their strengths and weaknesses.
- **PLO17**: Be able to update and exploit advanced tools and techniques in the field of IoT in particular and IT in general term.
- **PLO18**: Have in-depth knowledge and skills in the persuited major or extensive knowledge and skills in the major close to the persuited major.

## Subjects - BIT_IoT_K16D-17A
...
- **CSI104**: Introduction to Computer_Nhập môn khoa học máy tính (3 credits)
...
- **NWC203c**: Computer Networking_Mạng máy tính (3 credits)
...
- **EDT202c**: Emerging Digital Technologies_Công nghệ số mới nổi (3 credits)
...
- **ESP301m**: Microcontroller and Embedded Programming_Lập trình vi điều khiển và nhúng (3 credits) | Pre-requisite: IOT102
- **IOP391**: IoT application development project_Dự án phát triển ứng dụng IoT (3 credits) | Pre-requisite: IoT102
...
- **IOS301**: IoT Security_Bảo mật IoT (3 credits) | Pre-requisite: MAD101
